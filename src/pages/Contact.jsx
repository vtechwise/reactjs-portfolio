  ...
  return (
    <section className="my-16">
      ...
      <div className="faq mt-6">
        ...
        <div className="collapse collapse-arrow bg-base-200 max-w-md">
          ...
          <div className="collapse-content">
            <p>
              ...
              foundation of my frontend development skills. Additionally, I have
              hands-on experience with popular frontend libraries and frameworks
              such as React.js, enabling me to build interactive and dynamic
        ...
        <div className="collapse collapse-arrow bg-base-200 max-w-md">
          ...
          <div className="collapse-content">
            <p>
              My approach to responsive web design involves using a mobile-first
              strategy. I prioritize the mobile user experience and then
              progressively enhance for larger screens. I leverage flexible
              grids and media queries to ensure that websites adapt seamlessly
        ...
        <div className="collapse collapse-arrow bg-base-200 max-w-md">
          ...
          <div className="collapse-content">
            <p>
              ...
              includes code splitting to reduce initial load times, lazy loading
              images and components to defer non-essential content, and
              minimizing HTTP requests through bundling. I also prioritize
              efficient caching strategies and utilize tools like Lighthouse to
        ...
        <div className="collapse collapse-arrow bg-base-200 max-w-md">
          <input type="radio" name="my-accordion-2" checked="checked" />
          <div className="collapse-title text-xl font-medium">
            What is your experience with version control systems, and which one
            do you prefer?
          </div>
          <div className="collapse-content">
            <p>
